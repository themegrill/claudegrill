---
name: setup
description: Set a theme or plugin up for themegrill-qa end to end — suite manifest, docs, knowledge file, credentials, licence, Playwright, CI workflow
...
# Set a product up for themegrill-qa
